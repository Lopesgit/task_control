...
// ---- Common Options ----
var gMonths=["Janeiro","Fevereiro","Março","Abril","Maio","Junho","Julho","Agosto","Setembro","Outubro","Novembro","Dezembro"];
...
var gsBottom="<A href='javascript:void(0)' class='BottomAnchor' onclick='if(this.blur)this.blur();if(!fSetDate(gToday[0],gToday[1],gToday[2]))alert(\"Data indisponível.\");return false;' onmouseover='return true;' >Hoje : "+gToday[2]+" de "+gMonths[gToday[1]-1]+" de "+gToday[0]+"</A>";	// the content of the bottom section.
